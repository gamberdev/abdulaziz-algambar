...
const QualificationSection = () => {
  ...
  const forYouItems = [t("qual.f1"), t("qual.f2"), t("qual.f3"), t("qual.f4"), t("qual.f5")];
  const notForYouItems = [t("qual.n1"), t("qual.n2"), t("qual.n3")];
    ...
    <section className="py-24 md:py-32 relative">
      ...
      <div className="container relative z-10 px-6 md:px-12 lg:px-20">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <p className="text-sm font-body tracking-[0.3em] uppercase text-primary mb-4">{t("qual.label")}</p>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold text-foreground leading-tight">
            {t("qual.title1")}{" "}
            <span className="text-gradient-gold">{t("qual.title2")}</span>
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div className="rounded-xl border border-gold-subtle bg-card p-8 md:p-10 transition-all duration-300 hover:border-primary/30">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-xl font-display font-semibold text-foreground">{t("qual.for")}</h3>
            </div>
            <ul className="space-y-5">
              {forYouItems.map((item, i) => (
                <li key={i} className="flex items-start gap-3">
                  ...
                  <span className="font-body text-secondary-foreground leading-relaxed">{item}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="rounded-xl border border-border bg-card/50 p-8 md:p-10">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-xl font-display font-semibold text-foreground">{t("qual.notfor")}</h3>
            </div>
            <ul className="space-y-5">
